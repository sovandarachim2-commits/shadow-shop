...
class SiteSettings(models.Model):
    ...
    login_logo = models.ImageField(upload_to='site/login/', null=True, blank=True)
    splash_logo = models.ImageField(upload_to='site/splash/', null=True, blank=True)
    splash_enabled = models.BooleanField(default=True)
    splash_duration_ms = models.PositiveIntegerField(default=3000)
