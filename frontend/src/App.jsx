...
const ADMIN_FALLBACK_ROUTES = [
  ...
  { module: 'inventory_movements', path: '/admin/inventory/movements' },
  { module: 'inventory_transfers', path: '/admin/inventory/transfers' },
  { module: 'print', path: '/admin/print' },
  { module: 'print_history', path: '/admin/print/history' },
  ...
  { module: 'finance_expenses', path: '/admin/finance/expenses' },
  { module: 'finance_profit', path: '/admin/finance/profit' },
  { module: 'rewards', path: '/admin/rewards' },
  { module: 'rewards_products', path: '/admin/rewards/products' },
  { module: 'rewards_coupons', path: '/admin/rewards/coupons' },
  { module: 'rewards_exchanges', path: '/admin/rewards/exchanges' },
  { module: 'rewards_settings', path: '/admin/rewards/settings' },
  { module: 'rewards_transactions', path: '/admin/rewards/transactions' },
  { module: 'rewards_points', path: '/admin/rewards/points' },
  { module: 'reports', path: '/admin/reports/sales' },
  { module: 'reports_products', path: '/admin/reports/products' },
  { module: 'reports_inventory', path: '/admin/reports/inventory' },
  { module: 'users', path: '/admin/users' },
  { module: 'users_roles', path: '/admin/roles' },
  { module: 'users_activity', path: '/admin/activity' },
  { module: 'settings', path: '/admin/settings' },
  { module: 'settings_telegram', path: '/admin/settings/telegram' },
  { module: 'settings_delivery', path: '/admin/settings/delivery' },
  { module: 'settings_payment', path: '/admin/settings/payment' },
  { module: 'settings_print_logo', path: '/admin/settings/print-logo' },
  { module: 'settings_login_logo', path: '/admin/settings/login-logo' },
  { module: 'settings_customer_footer', path: '/admin/settings/customer-footer' },
]
