...
export default function OrderSuccessModal({ open, onTrack, onBack }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-gray-900/45 px-4 backdrop-blur-[2px]">
      <div className="w-full max-w-[320px] rounded-[1.75rem] bg-white px-8 py-10 text-center shadow-2xl">
        <div className="mx-auto flex h-[72px] w-[72px] items-center justify-center rounded-full border-[5px] border-green-600 bg-green-50">
          <Check className="text-green-600" size={34} strokeWidth={3} />
        </div>

        <h2 className="mt-6 text-[1.65rem] font-black leading-tight text-gray-950">
          {t('orders.congratulations')}
        </h2>
