...
function transactionMeta(item, t) {
  ...
  if (note.includes('referral') || note.includes('friend')) return { icon: Users, title: t('rewardsPage.history.referralBonus'), tone: 'bg-pink-50 text-pink-600' }
      ...
      <div className="mx-auto w-full max-w-[1500px] px-5 md:px-6 md:pt-6">
        <header className="sticky top-0 z-30 -mx-5 flex min-h-[60px] items-center gap-3 bg-white/95 px-5 pt-[env(safe-area-inset-top)] backdrop-blur md:static md:mx-0 md:mb-6 md:min-h-0 md:bg-transparent md:px-0 md:pt-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-xs font-semibold text-gray-500">{t('rewardsPage.history.subtitle')}</p>
          </div>
        ...
        <h2 className="mb-2.5 mt-5 text-base font-black text-gray-950 md:text-lg">{t('rewardsPage.history.howYouEarn')}</h2>
