          ...
          <table className="w-full min-w-[980px] border-collapse text-center text-sm">
            ...
            <tbody>
              {isLoading ? (
                [...Array(6)].map((_, index) => (
                  <tr key={index}>
                    <td colSpan={8} className="border border-[#3b3f42] px-4 py-8">
                ...
                <tr>
                  <td colSpan={8} className="border border-[#3b3f42] px-4 py-16 text-gray-300">
                ...
                orders.map((order, index) => (
                  <tr key={`${order.source}-${order.id}`} className="hover:bg-[#252b2f]">
                    ...
                    <td className="border border-[#3b3f42] px-3 py-2 text-gray-300">{order.delivery_by}</td>
